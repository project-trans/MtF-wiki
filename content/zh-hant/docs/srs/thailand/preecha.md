...
```csv
技術,價格,勃起陰莖長度,要求,備註
陰莖皮膚翻轉,{{< currency 10300 USD >}},\> 15 cm,,BMI > 24.99 加收 10%；BMI > 30 加收 15%
陰莖皮膚翻轉和陰囊皮膚移植,{{< currency 10860 USD >}},5~15 cm,,BMI > 24.99 加收 10%；BMI > 30 加收 15%
乙狀結腸,{{< currency 18000 USD >}},任何長度,BMI < 24.99，HIV 陰性,
乙狀結腸（腹腔鏡）,{{< currency 22000 USD >}},任何長度,BMI < 21,
0 深度,{{< currency 9500 USD >}},,,
喉結切除術,{{< currency 3500 USD >}},,,可與SRS一起進行
```
...
術後第十五天複診時，診所會提供兩個擴張器；可額外購買其他尺寸擴張器。不論型號：

```csv
尺寸,價格
22 mm,{{< currency 1200 THB >}}
24 mm,{{< currency 1200 THB >}}
26 mm (no. 1),{{< currency 1200 THB >}}
28 mm (no. 1.5),{{< currency 1200 THB >}}
30 mm (no. 2),{{< currency 1200 THB >}}
32 mm (no. 2.5),{{< currency 1200 THB >}}
34 mm (no. 3),{{< currency 1500 THB >}}
```

- 購買 3 個擴張器的價格為 {{< currency 3500 THB >}}
- 購買 4 個擴張器的價格為 {{< currency 4500 THB >}}
- 購買 5 個擴張器的價格為 {{< currency 5500 THB >}}
