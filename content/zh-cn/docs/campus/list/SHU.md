...
- 校园跑使用运动世界校园 app，具有较强的反作弊手段，很难通过技术手段解决，限制较大。最好的解决方法是真的去跑。（何乐而不为呢？身体是革命的本钱）不过如果你客观条件不允许，可以谨慎地使用自行车来完成。- 课外活动和自选项目是对应的，需要刷卡，具体情况取决于老师。有的老师要求你真的活动，但有的老师会让你刷个卡就走。不过，课上训练时间不够的话，最好还是多用课外时间练习下，以防挂科。每学期要求 5 次课外活动。
