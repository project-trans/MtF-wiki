...
价格：{{< currency from="THB" to="CNY" value="300300" >}}
...
1. 实验室检查：
   价格：{{< currency from="THB" to="CNY" value="3300" >}} - {{< currency from="THB" to="CNY" value="6300" >}}
   检查项目：CBC，电解质，HIV，HBV，HCV，EKG，胸部 X 光片等
1. 每晚酒店住宿：
   价格：{{< currency from="THB" to="CNY" value="1800" >}} - {{< currency from="THB" to="CNY" value="5600" >}}
   位于医院大楼附近（步行 5 分钟）。您可能会在 <https://www.kamolhospital.com/k-garden/arrival/> 上看到更多信息。
1. 两封泰国精神科医生的信件：
   价格：{{< currency from="THB" to="CNY" value="4400" >}}。

额外费用：

1. 在以下情况下的回声和运动压力测试（EST）
    价格：{{< currency from="THB" to="CNY" value="7700" >}}
    - ≥ 50 岁的客户。
    - ≥ 40 岁且患有基础疾病，例如哮喘，高血压，心脏病，糖尿病，深静脉血栓形成等的客户。
1. 心脏病专家探访
    价格：{{< currency from="THB" to="CNY" value="1000" >}} - {{< currency from="THB" to="CNY" value="5000" >}}
