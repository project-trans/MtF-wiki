...
- 梁金 {{< shields/line "jin235" >}}、<jinliang222@gmail.com>、{{< shields/telegram "info4ts" >}}、{{< shields/wechat "LiangJin3039" >}}
    ...
    对Thiti医生的案例提供需额外付费的一站式服务，需绑定指定住宿、护理师套餐。一站式服务价格为{{< currency 10000 THB >}}，包含接送机、指定住宿与医疗机构之间往返接送、全程医疗翻译、跟医生面诊或复诊陪同、术后护理指导等，具体信息请咨询中介了解。

    24-26年的案例显示该中介安排的指定住宿为1R的Studio房型，家电齐全，最多入住3人，指定住宿费用可能随着入住人数增加而有所浮动，整体消费水平为{{< currency 1200 THB >}}到{{< currency 1500 THB >}}之间一晚，住院期间退房但提供免费行李寄存，价格以结算时为准。

    该中介在预约时需要缴纳{{< currency 5000 CNY >}}作为Thiti医生手术定金，可通过支付宝或国内银行转账支付，手术结束之后会原路退返，预约取消或因故无法手术定金不退，改期等情况的详细信息请咨询中介本人。

    该中介建议手术费外准备{{< currency 40000 THB >}}到{{< currency 60000 THB >}}，但考虑到赴泰手术的案例可能有囤HRT药物、润滑剂、改善和享受型消费以及应急备用金等需求，建议通过该中介找Thiti医生手术时，独自赴泰则手术费外准备{{< currency 60000 THB >}}到{{< currency 80000 THB >}}，每带多一个陪同小伙伴则在此基础上增加{{< currency 20000 THB >}}的资金准备。
