---
title: 实名信息变更指引
description: "该页面描述中国内地居民在修改身份证性别后变更各项实名制账户、证件、业务等内容的相关指引。基本都可凭「户口登记项目内容变更更正证明」（即性别、身份证号等户口登记内容的变更更正证明）和「新身份证」进行更改。"
weight: 700
---

该页面描述中国内地居民在修改身份证性别后变更各项实名制账户、证件、业务等内容的相关指引。基本都可凭「户口登记项目内容变更更正证明」（即性别、身份证号等户口登记内容的变更更正证明）和「新身份证」进行更改。需要说明的内容见下：
...
- 中国移动：更改身份证前过户到其他人名下，更改身份证后，再过户回来（可以尝试使用「中国移动 App」内的「异地过户」功能）。若没有提前过户到其他人名下，也可在更改身份证后凭新身份证和相关证明（可能需要户口本）前往归属地营业厅办理“信息变更”或“过户”业务（以归属地营业厅为准）。若需要跨省进行实名信息的变更，可以致电10086查询当地支持跨省视频台席的营业厅，携带新身份证和相关证明前往办理“信息变更”或“过户”业务（由于该服务仍在测试阶段，可能会出现无法办理的情况）。
