...
需在护士站借用剪刀（请及时归还）将发放的三卷纱布剪成长宽比约为 2:1 的长方形，随后将其全部撕成线条。先多次折叠可以减少剪裁次数，沿对角线撕较为省力。该操作预计需要数小时的工作，准备适量足够有趣的番剧或足够有趣的陪你聊天的朋友或可减轻该操作的心智负担（~~真的很无聊~~）。[^1]**入院后请尽快完成撕纱布操作并送至护士站灭菌**。该操作得到的碎纱会用于外阴止血，且填充效果和便捷性优于整块纱布。也就是说，**接受零深度 SRS 术者不需要撕纱布**。
