...
- 父母离异或其中一方去世的，可通过相应的材料（如离婚证等）或由家长手写「本人声明处于未婚状态（签名按手印）」进行证明，并对应减少同意书对另一方的相关内容要求。
- 父母均已故的，可由更长一辈的直系亲属签署同意书。
- 其中一方缺乏自理能力的，可以仅由另一方签署同意书并说明情况。
- 若相关亲属均无法签字，也可通过录制视频证明同意。
- 若已无更长辈的直系亲属在世，由兄弟姐妹签署同意书也可。
...
3. **父母同意书**[（模板）](icf.pdf)（正文部分手写或打印均可，签字必须手写，截止26年3月的信息均无需公证、无需按手印），**一份原件、两份复印件**
4. **无犯罪记录证明**（可在各省公安小程序办理，也可到线下户籍地派出所办理。该项材料有时效，一般为三个月，入院上交时没过期即可），**一份原件、两份复印件**
5. **未在婚姻状态声明**（**即使入院时未满法定婚龄，也需要该项材料**。部分地区街道办或居委会已经不再开具该证明，可**提交户口本本人页复印件一份**并**手写「本人声明处于未婚状态（签名按手印）」**替代），**手写三份或一份手写原件、两份复印件**
...
2. 可通过 [微医](https://wy.guahaoe.com/expert/book/96df355f-c720-11e1-913c-5cf9dd2e7135000?hospitalId=986cf2b7-c720-11e1-913c-5cf9dd2e7135000&hospDeptId=23dff9e0-f623-47f0-b65f-c08d9e2664e2000) 预约挂号
3. 可在门诊一楼现场挂号
4. 若无号可在门诊四楼整形外科现场请求护士加号

也可直接联系赵博：

1. 设法获取护士台电话后，通过护士台询问赵烨德医生在不在后联络 赵烨德医生
2. 与 赵烨德医生 交流，或在社群内设法获取其微信号后，预约面诊时间
...
据 2026 年 3 月对多个报告的统计，准备 65,000-70,000 元可以满足成形阴道的 SRS 的主要开支，零深度则为 65,000 元，入院时一般收取住院押金 50,000 元，需注意银行卡非柜面交易限额问题，提前和银行沟通解决方案。

据 2026 年初的多个报告显示，住院费用可能存在波动（如总花费增加约 5,000 元），建议酌情准备充足的资金并可积极关注近期完成手术的案例。
...
- 术中使用的止血材料 6216 ¥，零深度则为 3108 ¥
- 术后持续穿的抗血栓弹力袜 688 ¥（你可以自行准备该物品后送管床医生检查或联系管床医生购买），要求为医疗器械，长筒袜（即到大腿根部的）。
- 出院后公证费，约数百元
