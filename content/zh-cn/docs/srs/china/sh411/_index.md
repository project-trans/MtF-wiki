...
准备 65,000 元可以满足成形阴道的 SRS 的主要开支，零深度则为 60,000 元，入院时收取住院押金 50,000 元（公示于住院部一楼收费窗口旁，性身份障碍）。需注意银行卡非柜面交易限额问题，提前和银行沟通解决方案。
...
在开具住院证时会收走「易性证」诊断证明或其他类似物**原件**；若家长未陪同面诊并明确表示同意可能还需家长同意书，并可能向家长致电询问意见。
