...
- **外阴成形术（零深度）**
    - 仅构建外阴形态，不进行阴道造穴。
- **单纯阴茎切除术（“切平”术式）**
    - 仅切除阴茎与睾丸，使会阴部平整，不进行精细的外阴结构构建。
    - 说明：相比“零深度”术式，该手术创伤更小、恢复更快且费用更低。可与医生沟通是否保留阴蒂神经，埋于皮肤下。
    - 风险：因缺乏外部结构的支撑，尿道口狭窄/闭锁风险略高。可能可以与医生沟通，专门对尿道口进行处理，来降低此风险。
    > **证件变更**：经咨询，在本院进行此项手术（切平术式）**可以**开具《性别置换手术证明》，可用于办理身份证件性别变更。
...
赵烨德博士是国内仍在工作的性别重置手术领域经验最为丰富的医生。其术式特点是使用阴茎和或阴囊皮瓣制作阴道，并利用阴囊皮瓣成形阴唇。
...
* **缺点**：
    * 深度问题：赵医生倾向于认为 12cm 左右的深度已能满足需求，因此其预设深度可能相对保守。
    ...
    * 排期提醒：当前 SRS 手术排期较长（截至 2024 年 10 月排期已需要1.5年）。
...
**注意：赵博更重视父母在手术前的即时意见。即使持有公证过的父母同意书，若父母其中一方在术前强烈反对，仍可能导致无法办理住院或无法手术。**
...
注意：银行卡非柜面交易可能遇到限额问题，请提前和银行沟通解决方案。
...
注意：抗血栓袜支持微信/支付宝支付，止血材料仅支持支付宝扫码。
