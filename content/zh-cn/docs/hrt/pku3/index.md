...
进行 GAHT 之前需要先获得带有“易性症”诊断的病历或证明，没有有关证明或许可以开有关检查但是 GAHT 会被打回，详见 [心理科／精神科]({{< ref "psyco" >}})。
...
通过一些检查医生会确定你的身体情况是否适合进行 GAHT，并且会帮助监测一些副作用（大部分人会有骨量减少，需要补充维生素 D）。
涉及的检查包括
...
最后，开始 GAHT 之后最开始会每个月复查一次各种指标，以免出现不良反应，等稳定后三个月一次。一般的激素肝功检查一般花费在 150 元左右，视情况偶尔会有其他检查项目。
...
线上问诊无法开具 GAHT 处方，但是可以通过化验结果提供具体的 GAHT 用药建议。
