...
~~其实忘了也没事~~。如果已经推了一半，发现忘记回抽，不用恐慌或焦虑，继续打完就好了：股外侧肌中间缺乏较大的血管，真正完全在静脉内的概率其实极小；而且，现有意外静脉注射的报告，均为肺油微栓塞所致的短暂呼吸不适，因此不用恐慌；但是下次最好记住。详见参考与引用。{{< tag/pos "在检查回血的问题上，现在的指南存在争议。" >}}{{< tag/pos "许多当前的指南认为，并无证据显示经常有人在臀大肌外的安全注射部位打到过血管。" >}}
