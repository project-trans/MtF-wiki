---
title: "*GnRH 类似物"
description: GnRH 类似物在跨性别 HRT 中主要用于青春期阻断治疗。
---
...
GnRH 类似物用于青春期阻断治疗，亦可用于青春期后跨性别女性（MtF）HRT 治疗中的抗雄类药物。其分为激动剂和拮抗剂两种，作用于脑垂体 GnRH 受体；虽然激动剂治疗初期激素水平上升，但持续治疗后，二者疗效相当，均控制激素在青春期前范围内[^1] [^2] [^3]。
...
对于完成了部分或全部青春期发育进程的跨性别女性，仍可将其作为抗雄药物使用， 但无法起到逆转已经完成的发育进程的效果。广州华侨医院的高绿芬医生会建议刚成年不久的跨性别者使用。其优点在于一次用药的作用时间长，相对于醋酸环丙孕酮（CPA）**不易引起**包括但不限于：肝功能异常、泌乳素升高、抑郁、累积剂量过高导致的垂体瘤。唯须自行衡量是否值得，因其同周期费用可能为其它抗雄药物的数十倍（贵……），而又已经没有了“青春期阻断”这一特殊效果。
...
另外，用于该治疗的 GnRH 类似物价格较为高昂。例如在国内，注射用醋酸亮丙瑞林微球 3.75 mg 剂型（每月注射一次）的集采中选价介乎 896.98～902.98 元（国产 896.98 元[^9]，原研 902.98 元[^7]；中位数 899.98 元），按每月一次计，一年总开销约一万一千元。

三个月一次的 11.25 mg 长效剂型（原研集采价 2093.77 元/针[^7]）每年仅需注射 4 次，折算年开销约八千四百元，成本更低，且减少了打针的次数，是更佳选择。
...
[^7]: 王道斌. 广东集采成果加速落地，性早熟患儿治疗可及性提升新福音 [EB/OL]. *南方都市报*, 2026-02-04. <https://www.163.com/dy/article/KKUM0NSI05129QAF.html>
...
[^9]: 亳州市卫生健康委员会. 药品价格公示 [EB/OL]. <https://wjw.bozhou.gov.cn/XxgkContent/show/2436692.html>
