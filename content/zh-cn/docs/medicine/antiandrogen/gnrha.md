...
对于成年跨性别者，仍可将其作为抗雄药物使用（但是已经错过了青春期）， 广州华侨医院的高绿芬医生会建议刚成年不久的跨性别者使用。其优点在于一次用药的作用时间长，相对于醋酸环丙孕酮（CPA）**不易引起**包括但不限于：肝功能异常、泌乳素升高、抑郁、累积计量导致的垂体瘤。唯须自行衡量是否值得，因其同周期费用可能为其它抗雄药物的数十倍（贵……），而又已经没有了“青春期阻断”这一特殊效果。
