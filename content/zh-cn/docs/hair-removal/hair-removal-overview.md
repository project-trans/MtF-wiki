...
- **Thermolysis（RF/AC）**：电极尖端产生**焦灼性热凝**（Joule heating），在毛囊底部形成**凝固性坏死**，直接波及 **papilla**，并可累及下段 **bulge**。
...
- **不良后果与连锁影响（简述）**：牵引与剪切可致毛囊口微损伤与**倒毛／pseudofolliculitis／细菌性毛囊炎**[^7] [^8] [^9]；深色肤质（Fitzpatrick III–VI）**PIH** 风险与持续时间更高[^10]；少数可出现**绿脓杆菌毛囊炎暴发**或会阴/外阴**严重感染**等并发症[^11] [^12] [^13]
