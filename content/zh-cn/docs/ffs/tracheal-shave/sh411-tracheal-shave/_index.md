...
本页面所述为在上海四一一医院进行喉结切除的经历。挂号等一般性内容请同时参考阅读[上级页面]({{< ref "preparation#挂号方式" >}})。
...
如果你刚在上海四一一医院完成了 SRS，紧接着行喉结切除术，或者你打算这么做，可以在入院时告知，并在SRS办理出院后再次办理入院（因医院不能同时结算 SRS 与喉结切除术账单）。
