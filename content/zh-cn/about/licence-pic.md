...
部分涉及敏感内容的材料，尤其是图片，可能依据下列协议进行许可。使用相关内容时，请特别注意下列许可协议中所列出的的条款和条件。如果您对具体哪些材料涉及该许可协议或有其它疑问，请联系 <mtfwiki@project-trans.org>。
...
2. 例外和限制：为避免疑义，若著作权的例外和限制适用于您对授权作品的使用，本许可协议将不适用，您也无须遵守本许可协议之条款。
