...
臨床試験において、医師の指導下で行うGAHTの安全性は認められている[^2]。国際連合機関・[人権高等弁務官事務所](https://www.ohchr.org)（OHCHR）の提案した「[UN Free &amp; Equal](https://www.unfe.org)」（国連Free & Equalキャンペーン）及び「[The Yogyakarta Principles](https://yogyakartaprinciples.org)」（[ジョグジャカルタ原則](https://ja.wikipedia.org/wiki/%E3%82%B8%E3%83%A7%E3%82%B0%E3%82%B8%E3%83%A3%E3%82%AB%E3%83%AB%E3%82%BF%E5%8E%9F%E5%89%87)）において、性別適合の医学的対応、及びGI当事者の人権の保障が推奨されている。
...
**エストロゲン**（Estrogen）は、**エストロン**（Estrone/E<sub>1</sub>）、**エストラジオール**（Estradiol/E<sub>2</sub>）、**エストリオール**（Estriol/E<sub>3</sub>）の3種類からなるステロイドホルモンの一種。一般に卵胞ホルモン、女性ホルモンと呼ばれる。その中でも、エストラジオールは女性の卵巣から分泌され、最も強い生理活性を持つ代表的な卵胞ホルモンであり、MtFに対するGAHTで主に投与される薬剤である[^5]。

現在用いられているホルモン濃度基準では、成人・閉経前女性において、血中エストラジオール濃度は平均約**100 pg/mL**である。発表された性同一性障害診断・治療ガイドラインでは、MtFにおいて、血中エストラジオールはほぼ一定の濃度（100〜200 pg/mL）を維持することが推奨されている[^1] [^4]。\
...
思春期のMtFにおいては、ホルモン濃度基準が成人より低いため、エストロゲンの投与量は少なくできる。また、男性としての二次性徴の進行を抑制するため、GnRHa、あるいはプロゲスチン（黄体ホルモン類似物）も使用できる[^5]。
...
-血中エストラジオール濃度の検査結果によると、吉草酸エストラジオール錠の投与群では、エストラジオール錠の投与群と比較して25%低くなるため、可能であればエストラジオール錠の使用を推奨すること[^7]。
...
- 動物試験の結果、エストロゲンが、視床下部・脳下垂体・性腺の機能を抑制し、精原細胞・精母細胞を減少させ、性機能を一部低下させるとの報告がある[^10] [^11]。\
  ...
  MtFを対象とした臨床試験の結果、ホルモン療法を中止した3〜6ヶ月後、造精機能の全般改善度が約24%であり、精子量の中央値がホルモンを投与しなかった男性と比較して低くなるとの報告がある。また、ホルモン療法を継続したMtFにおいて、精子量がホルモンを投与しなかった男性と比較して95%以上低くなるとの報告がある[^12] [^13]。
-経口エストロゲン剤（特に合成製剤）は血栓症の危険性を高める[^4] [^14]。合成エストロゲン製剤はGAHTに使用しないこと。販売されている合成製剤には下記が含まれる：
  - 結合型エストロゲン（CEE）
  - エチニルエストラジオール（EE）
- エストロゲン製剤とゲスタゲン（黄体ホルモン）製剤を長期併用した場合、乳癌になる危険性が高くなり、その危険性は併用期間が長期になるに従って高くなるとの報告がある[^16] [^17]。乳癌家族素因が強い者は、必ず医師に相談すること。
-血中テストステロン・エストラジオール濃度を定期的に確認すること。原則として、その二つを成人女性のホルモン濃度基準範囲内に維持すること。エストラジオールが不足する場合、GAHTの有効性が不十分になる。一方、その二つがいずれも不足する場合、Hot flush、発汗や骨粗鬆症などの可能性が高くなる。

## 抗アンドロゲン剤について

通常、成人に対する低〜中等量のエストロゲン投与では、抗アンドロゲン剤1種類との併用が必要である[^1]。併用しない場合、GAHTの効果は不十分になる。なお、血中テストステロンを減少させるため、エストロゲンの大量投与を単独で行う場合もある（詳細は上記）。
...
- MtFにおいて、ゲスタゲン製剤による身体的変化への効果は明らかでなく、臨床試験もほとんど実施されていない[^1] [^4] [^5]。
...
- 「[性同一性障害者の性別の取扱いの特例に関する法律](https://ja.wikipedia.org/wiki/%E6%80%A7%E5%90%8C%E4%B8%80%E6%80%A7%E9%9A%9C%E5%AE%B3%E8%80%85%E3%81%AE%E6%80%A7%E5%88%A5%E3%81%AE%E5%8F%96%E6%89%B1%E3%81%84%E3%81%AE%E7%89%B9%E4%BE%8B%E3%81%AB%E9%96%A2%E3%81%99%E3%82%8B%E6%B3%95%E5%BE%8B)」（性同一性障害特例法）：2003年7月10日に成立し、2004年7月16日に施行された日本の法律。
  -性別変更の要件である生殖機能の手術については、最高裁判所大法廷が2023年10月に違憲判断を示し、その後、長崎高等裁判所では2024年7月に「**憲法違反の疑いがあると言わざるをえない**」と判断された[^99]。
